 ...
 * @author Dany
 */
public class AddBoletinDialog extends javax.swing.JDialog {

    /**
     * Creates new form AddBoletinDialog
     */
    public AddBoletinDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        String fecha = "";
        switch(decenaCB.getSelectedItem().toString()){
            case "Primera" -> fecha = "1ra/"+mesCB.getSelectedItem().toString()+"/"+annoCB.getSelectedItem().toString();
                
            case "Segunda" -> fecha = "2da/"+mesCB.getSelectedItem().toString()+"/"+annoCB.getSelectedItem().toString(); 
            
            case "Tercera" -> fecha = "3ra/"+mesCB.getSelectedItem().toString()+"/"+annoCB.getSelectedItem().toString();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBoletinDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddBoletinDialog dialog = new AddBoletinDialog(new javax.swing.JFrame(), true);
